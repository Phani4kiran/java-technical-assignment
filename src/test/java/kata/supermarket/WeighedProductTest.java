...
class WeighedProductTest {
    ...
    @ParameterizedTest
    @MethodSource
    void itemFromWeighedProductHasExpectedUnitPrice(String id, String pricePerKilo, String weightInKilos, String expectedPrice) {
    ...
    static Stream<Arguments> itemFromWeighedProductHasExpectedUnitPrice() {
        return Stream.of(
                Arguments.of("W001", "100.00", "1.00", "100.00"),
                Arguments.of("W002", "100.00", "0.33333", "33.33"),
                Arguments.of("W003", "100.00", "0.33335", "33.34"),
                Arguments.of("W004", "100.00", "0", "0.00")
        );
    }
